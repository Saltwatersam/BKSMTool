...
namespace BKSMTool.Controls
{
    ...
    */
    ...
    public partial class AdvancedTrackbar : Control
    {
        #region Events
        ...
        [Category("ColorSlAdvancedTrackbarider")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedTrackbar"/> class.
        /// </summary>
        /// <param name="min">The minimum value.</param>
        /// <param name="max">The maximum value.</param>
        /// <param name="value">The current value.</param>
        public AdvancedTrackbar(decimal min, decimal max, decimal value)
        {
            InitializeComponent();
        ...
        /// Initializes a new instance of the <see cref="AdvancedTrackbar"/> class.
        /// </summary>
        public AdvancedTrackbar() : this(0, 100, 30) { }
        ...
        /// <summary>
        /// Draws the AdvancedTrackbar control using passed colors.
        /// </summary>
            ...
            Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                if (_tickStyle != TickStyle.None)
                {
                    ...
                    // Calculate radiusX W to draw graduations 
                    // Remove the radiusX of the thumb (half thumb at each end)
                        ...
                        if (_barOrientation == Orientation.Horizontal)
                        {
                            ...
                            if (_showDivisionsText)
                            {
                                if (_tickStyle == TickStyle.TopLeft || _tickStyle == TickStyle.Both)
                                {
                                    ...
                                    //ty = barRect.Y + barRect.RadiusY / 2 - (1.5F)*(size.RadiusY) - scaleL - offset;
                                ...
                                {
                                    tx = (start + barRect.X + interval) - (float)(size.Width * 0.5);
                                    //ty = barRect.Y + barRect.RadiusY/2 + (size.RadiusY/2) + scaleL + offset;
