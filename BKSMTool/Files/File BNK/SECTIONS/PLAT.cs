...
{
    /// <summary>
    /// Represents the PLAT section inside a BNK file, typically used for platform-specific data.
    /// Implements <see cref="IDisposable"/> to ensure proper resource management.
    /// </summary>
    public class Plat : FourccStruct, IDisposable
    {
        // Flag to indicate whether the object has been disposed
        private bool _disposed;

        /// <summary>
        /// 4 bytes storing the length of the PLAT section in the BNK file.
        /// </summary>
        public byte[] SectionLength = new byte[4];

        /// <summary>
        /// Stores any unknown or unmanaged leftover bytes at the end of the PLAT section.
        /// </summary>
        public byte[] LeftBytes = { };

        #region Dispose
        /// <summary>
        /// Releases all resources used by the <see cref="Plat"/> object.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="Plat"/> and optionally releases managed resources.
        /// </summary>
