...
{
    /// <summary>
    /// Represents the STMG section inside a BNK file, typically used for managing streaming-related data.
    /// Implements <see cref="IDisposable"/> to ensure proper resource management.
    /// </summary>
    public class Stmg : FourccStruct, IDisposable
    {
        // Flag to indicate whether the object has been disposed
        private bool _disposed;

        /// <summary>
        /// 4 bytes storing the length of the STMG section in the BNK file.
        /// </summary>
        public byte[] SectionLength = new byte[4];

        /// <summary>
        /// Stores any unknown or unmanaged leftover bytes at the end of the STMG section.
        /// </summary>
        public byte[] LeftBytes = { };

        #region Dispose
        /// <summary>
        /// Releases all resources used by the <see cref="Stmg"/> object.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="Stmg"/> and optionally releases managed resources.
        /// </summary>
