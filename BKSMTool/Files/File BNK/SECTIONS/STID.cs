...
{
    /// <summary>
    /// Represents the STID section inside a BNK file, which stores information related to soundbanks' IDs.
    /// Implements <see cref="IDisposable"/> to ensure proper resource management.
    /// </summary>
    public class Stid : FourccStruct, IDisposable
    {
        // Flag to indicate whether the object has been disposed
        private bool _disposed;

        /// <summary>
        /// 4 bytes storing the length of the STID section in the BNK file.
        /// </summary>
        public byte[] SectionLength = new byte[4];

        /// <summary>
        /// Stores any unknown or unmanaged leftover bytes at the end of the STID section.
        /// </summary>
        public byte[] LeftBytes = { };

        #region Dispose
        /// <summary>
        /// Releases all resources used by the <see cref="Stid"/> object.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="Stid"/> and optionally releases managed resources.
        /// </summary>
